...
public:
    ...
    bool found(const std::vector<std::string> sset, const std::string& targ) const;


    void swapAdj(const std::string& word, std::vector<std::string>& result) const;

    void inBetween(const std::string& word, std::vector<std::string>& result) const;

    void delChar(const std::string& word, std::vector<std::string>& result) const;

    void replaceChar(const std::string& word, std::vector<std::string>& result) const;

    void splitChar(const std::string& word, std::vector<std::string>& result) const;
