...
public:
    ...
    //my functions
    void setCursorLine(int value);

    void setCursorCol(int value);

    void modify(bool opCode, char key = '\0');

    void setLineContent(int line, const std::string& str);

    void removeLine(int line);

    void insertLine(int line, const std::string& line_content);
